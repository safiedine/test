...
url <- "https://raw.githubusercontent.com/DrSaadLa/MLLabs/main/data/Ecommerce_Customers.csv"
e_customers <- read.csv(url)
 save(e_customers, file = "e_customers.RData")
load(file = "e_customers.RData")
glimpse(e_customers)
...
# Explore the distribution of the dependent variable" Yearly_amoun --------
...
#### Scatter Matrix with PerformanceAnalytics package --------------------------------------
